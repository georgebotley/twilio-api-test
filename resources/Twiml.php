...
class Twiml extends ErrorHandler {
	...
	*/
    public function __construct($arg = null) {
        ...
        case is_array($arg):
            ...
            break;
        default:
            $this->throwError('Unable to make Twiml. Invalid Argument.', __FILE__, __LINE__);
        }
    }
	...
	* @access public
	*
	* @method $this->say('hello'); = <Say>hello</Say>
	* @method $this->say('hello', array('voice' => 'woman'); = <Say voice='woman'>hello</Say>
	* @method $this->gather(array('timeout' => '20'); = <Gather timeout='20'/>
	*
 	* @param string $very = The Twiml verb.
 	* @param array $args
	*
	* @param SimpleXmlElement|array $arg: Can be any of
    *   - (noun string)
